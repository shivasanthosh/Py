...
def solve( A):
    ...
    if pSum[arr_size - 1] - pSum[0] == 0:
        return 0
    if pSum[arr_size - 1] == 0:
        return arr_size - 1
    for i in range(1, arr_size - 1):
        if pSum[i - 1] == pSum[arr_size - 1] - pSum[i]:
            return i
    return -1
